...
class __TwigTemplate_34876a046e1e32f4492924dd925cca4a extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["is_top_level_menu"] ?? null) && twig_get_attribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 129))) ? ("primary-nav-submenu-toggle-button") : (false))]), "html", null, true);
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/navigation/menu--primary-menu.html.twig", "C:\\xampp\\htdocs\\vendorportal\\web\\core\\themes\\olivero\\templates\\navigation\\menu--primary-menu.html.twig");
    }
